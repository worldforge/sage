...
typedef  (APIENTRYP SAGE_PFNGLMAPBUFFERPROC) (GLenum, GLenum);
...
typedef  (APIENTRYP SAGE_PFNGLMAPBUFFERARBPROC) (GLenum, GLenum);
...
typedef  (APIENTRYP SAGE_PFNGLMAPOBJECTBUFFERATIPROC) (GLuint);
